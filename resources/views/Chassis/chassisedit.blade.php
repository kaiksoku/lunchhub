...
<div class="container">
    ...
    <div class="card card-outline card-warning">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('chassis.update') }}" method="POST" class="form-chassis">
                @csrf
    ...
    <div class="col-md-6">
        ...
        <input
            ...
            name="chass_numero"
            id="chass_numero"
            value="{{ old('chass_numero', $chassis->chass_numero) }}"
            required  readonly
        >
    </div>
    ...
    <div class="col-md-6">
        ...
        <input
            ...
            name="chass_placa"
            id="chass_placa"
            value="{{ old('chass_placa', $chassis->chass_placa) }}"
            required  readonly
        >
    </div>
</div>
...
<div class="row mb-3">
    <div class="col-md-4">
        ...
        >
            ...
            <option value="2" {{ old('chass_ejes', $chassis->chass_ejes) == 2 ? 'selected' : '' }}>2</option>
            <option value="3" {{ old('chass_ejes', $chassis->chass_ejes) == 3 ? 'selected' : '' }}>3</option>
        </select>
    </div>
    ...
    <div class="col-md-4">
        ...
        >
            <option value="">Seleccione una opción</option>
            <option value="20" {{ old('chass_medida', $chassis->chass_medida) == 20 ? 'selected' : '' }}>20</option>
            <option value="40" {{ old('chass_medida', $chassis->chass_medida) == 40 ? 'selected' : '' }}>40</option>
        </select>
    </div>
    ...
    >
        <option value="Disponible"
            {{ old('chass_estado', $chassis->chass_estado ?? 'Disponible') == 'Disponible' ? 'selected' : '' }}>
            Disponible
        </option>

        <option value="Taller"
            {{ old('chass_estado', $chassis->chass_estado ?? 'Disponible') == 'Taller' ? 'selected' : '' }}>
            Taller
        </option>
    </select>
</div>
...
<div class="row mb-8">
    <div class="col-md-8">
        ...
        <input
            ...
            id="chass_estructura"
            value="{{ old('chass_estructura', $chassis->chass_estructura) }}"
            required
        >
    </div>
</div>
