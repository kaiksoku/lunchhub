    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('solicitudes') }}" class="btn btn-outline-success">
                ...
                <div class="form-container">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="mealType" name="soli_tiempo" required onchange="updateOrderSummary()">
